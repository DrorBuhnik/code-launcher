...
import {getProjectDisplayLabel, isRelevantDir, isSkippableDirName, SCAN_LIMIT_DEPTH, SCAN_LIMIT_PROJECTS,} from './utils.js';
...
export async function scanForIdeaProjectsAsync(rootPath, opts = {}) {
  ...
  while (stack.length > 0 && projectsSet.size < SCAN_LIMIT_PROJECTS) {
